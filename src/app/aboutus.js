          ...
          <div className="w-full px-6 py-4 rounded-2xlmd:p-0 lg:px-12">
            ...
            <div className="mb-4">
              ...
              <div className={`overflow-hidden transition-all duration-500 ${activeSection === 'mission' ? 'max-h-screen' : 'max-h-0'}`}>
                {activeSection === 'mission' && (
                  <div className="bg-azul3 p-4 rounded-b-md">
                    <p className="text-base font-sf-display leading-relaxed text-white md:text-base">
            ...
            <div className="mb-4">
              ...
              <div className={`overflow-hidden transition-all duration-500 ${activeSection === 'team' ? 'max-h-screen' : 'max-h-0'}`}>
                {activeSection === 'team' && (
                  <div className="bg-azul3 p-4 rounded-b-md">
                    <p className="text-base font-sf-display leading-relaxed text-white md:text-xl">
            ...
            <div className="mb-4">
              ...
              <div className={`overflow-hidden transition-all duration-500 ${activeSection === 'values' ? 'max-h-screen' : 'max-h-0'}`}>
                {activeSection === 'values' && (
                  <div className="bg-azul3 p-4 rounded-b-md">
                    <ul className="list-disc list-inside text-base font-sf-display leading-relaxed text-white md:text-xl">
