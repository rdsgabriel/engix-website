...
export default function Wpp() {
  return (
    ...
    className="fixed z-20 bottom-2 right-2 sm:bottom-5 sm:right-5 text-white bg-green-500 opacity-70 p-3 rounded-full shadow-lg hover:opacity-100 transition-colors pulse"
    target="_blank"
